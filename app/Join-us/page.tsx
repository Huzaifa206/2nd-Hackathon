...
export default function JoinUs() {
    ...
    <div className="flex flex-col items-center py-10">
           ...
           <form action="" className="flex flex-col mx-auto w-96">
             ...
             <input className="mx-auto w-80 md:w-96 border-[#E5E5E5] rounded-md mb-4 px-4 py-3 border-[2px] " type="text" placeholder="First Name" />
             <input className="mx-auto w-80 md:w-96 border-[#E5E5E5] rounded-md mb-4 px-4 py-3 border-[2px] " type="text" placeholder="Last Name" />
             <input className="mx-auto w-80 md:w-96 border-[#E5E5E5] rounded-md mb-2 px-4 py-3 border-[2px] " type="text" placeholder="Date of Birth" />
             <p className='mx-auto w-80 md:w-96 pb-3  text-sm md:text-base text-center'>Get a Nike Member Reward every year on your Birthday.</p>
             <select className="mx-auto w-80 md:w-96 border-[#E5E5E5] rounded-md mb-2 px-4 py-3 border-[2px] " name="" id="">
      ...
      <div className="flex justify-between items-center py-7 mx-auto w-80 md:w-96 text-sm md:text-base">
          ...
          <label className="mx-auto w-80 md:w-96 pl-2 cursor-pointer " htmlFor="remember">
            Sign up for emails to get updates from Nike on products, offers and your Member benefits
          </label>
      
      </div>
      <p className="mx-auto w-80 md:w-96 text-sm md:text-base text-center pb-6">By creating an account, you agree to Nike's Privacy Policy and Terms of Use.</p>
