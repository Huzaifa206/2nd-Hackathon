        ...
        <div className="grid grid-cols-12 px-8 md:px-16 py-8 bg-white text-gray-800">
            <div className='col-span-9 border-r-[1.3px] pr-4 border-text-secondary-gray'>
                ...
                <div className='flex mt-4 gap-4'>
                    <button className="rounded-full py-2">Join us</button>
                    <button className="rounded-full py-2">Shop Nike</button>
                ...
                <div className="mb-6">
                    ...
                    <div className="flex space-x-2">
                        <Image src="/thumbs-up.svg" alt="Thumbs Up" width={40} height={40} className="w-6 h-6 cursor-pointer"/>
                        <Image src="/thumbs-down.svg" alt="Thumbs Down" width={40} height={40} className="w-6 h-6 cursor-pointer"/>
                    </div>
                </div>
