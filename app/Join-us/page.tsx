...
export default function JoinUs() {
    ...
    <div className="flex flex-col items-center py-10">
      ...
      <div className="flex justify-between items-center py-7 mx-auto w-80 md:w-96">
        <div>
      ...
      <p className="mx-auto w-80 md:w-96 text-text-secondary-gray text-center pb-6">By creating an account, you agree to Nike's Privacy Policy and Terms of Use.</p>
